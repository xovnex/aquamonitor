...
export default function VerificarPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-grid" style={{ background: '#060d1a' }}>
      <div
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        <div className="text-center mb-8 animate-fade-up">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #1eb8f0, #0878a8)', boxShadow: '0 0 32px rgba(30,184,240,0.5)' }}
          >
            <Mail size={28} className="text-white" />
          </div>
          <h1 className="text-2xl font-bold text-white">Verifica tu cuenta</h1>
          <p className="text-sm text-white/40 mt-1">Revisa tu bandeja de entrada</p>
        </div>

        {/* Card */}
        <div className="glass-card p-7 animate-fade-up" style={{ animationDelay: '150ms' }}>
          ...
          <form onSubmit={handleVerificar} className="space-y-4">
            <div>
              <label className="stat-label block mb-1.5">Código de 6 dígitos</label>
              <input
            ...
            <button type="submit" disabled={loading || codigo.length !== 6} className="btn-primary w-full flex items-center justify-center gap-2">
              {loading ? (
          ...
          <div className="mt-4 text-center">
            ...
            >
              {reenviando ? 'Reenviando...' : reenviado ? 'Reenviado ✅' : 'Reenviar código'}
            </button>
          </div>
        </div>
